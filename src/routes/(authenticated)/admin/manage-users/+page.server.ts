        ...
        try {
            ...
            if (error instanceof APIError) {
                if (error.body?.message)
                    return setError(form, '', error.body.message);
                else
                    return setError(form, '', 'Une erreur est survenue lors de la création de l\'utilisateur');
            }
            throw error;
        }
    },
        ...
        try {
            ...
            if (error instanceof APIError) {
                if (error.body?.message)
                    ...
                    return setError(form, '', 'Une erreur est survenue lors de la mise à jour de l\'utilisateur');
            }
            throw error;
        }
    }
